package com.hqf.circleimageview.view;
...
import com.hqf.circleimageview.R;

/**
 * Created by huangqianfang on 2017/6/6.
...
public class CircleImageView2 extends ImageView {
	...
	public CircleImageView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
		...
		mBorderWidth = typedArray.getDimensionPixelSize(R.styleable.CircleImageView_border_with, DEFAULT_BORDER_WIDTH);

		mBorderOverlay = typedArray.getBoolean(R.styleable.CircleImageView_border_color, DEFAULT_BORDER_OVERLAY);
